...
public class invoice_view extends javax.swing.JFrame {
    ...
    TableModel tm;
    JLabel j1;
    public invoice_view(TableModel tm,JLabel j1) {
        initComponents();
        ...
        this.j1=j1;
         ...
         try {
           String totalmap=this.j1.getText();
            
            String MainReportPath="src//Reports//invoice1.jasper";
            HashMap<String,Object>map=new HashMap<>();
            map.put("Parameter1", totalmap);
    ...
    private void initComponents() {
        ...
        getContentPane().add(jButton6, new org.netbeans.lib.awtextra.AbsoluteConstraints(1300, 10, 40, 40));
